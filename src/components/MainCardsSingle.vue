...
<style scoped lang="postcss">
  .card {
    @apply cursor-pointer overflow-hidden rounded-md bg-gray-300 p-6 shadow-md transition-transform duration-300 hover:scale-110 hover:shadow-2xl hover:shadow-gray-900;
    &-image {
      img {
    ...
    &-details {
      ...
      &-name {
        @apply text-3xl font-thin  tracking-wider text-gray-800;
      }
      &-job {
        @apply -mt-2 text-xs font-bold text-red-600;
      }
      &-quote {
        @apply pt-4 text-lg italic text-gray-800;
      }
    }
  }
</style>